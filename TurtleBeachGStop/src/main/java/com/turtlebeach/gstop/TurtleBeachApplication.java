...
import com.clickbrand.turtlebeach.update.UpdateService;
...
public class TurtleBeachApplication extends Application {
	...
	public void onCreate() {
		...
		// Start the localytics session
		NWBaseActivity.startLocalyticsSession(this);
		...
		if (peace.contains("REBOOT")) {
			NWBaseActivity.logEvent(this, NWBaseActivity.EVENT_REBOOT, null);
		...
		NWBaseActivity.logEvent(this, NWBaseActivity.EVENT_APP_START, attrs);
