 ...
 */
public class SplashScreenActivity extends NWBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
		...
		//We don't want to log this as a screen with localytics.
		sScreenName = null;
        try {
        ...
        if(!PreferenceManager.getDefaultSharedPreferences(this).contains(STORE_ZIP)) {
